...
KangooCan::KangooCan(BMSCan &bmscan, EEPROMSettings &settings)
{
    this->numModules = 12;
};
...
void KangooCan::printPackDetailsJson(JsonDocument &root)
{
    JsonObject packDetailsNode = root.add<JsonObject>();
